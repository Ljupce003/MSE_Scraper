...
csv_file_path = "../Baza/Example_data/mega-data.csv"  # замени со вистинскиот пат до CSV документот
json_file_path = "../Baza/Example_data/issuer_names.json"  # замени со вистинскиот пат до JSON документот
output_json="../Baza/last_dates.json"
last_dates_json_path = "../Baza/Example_data/last_dates.json"  # замени со вистинската патека до JSON документот
